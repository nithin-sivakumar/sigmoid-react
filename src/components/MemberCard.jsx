...
const MemberCard = ({ member }) => {
  return (
    <div className="flex-1 border-2 border-gray-400 hover:border-black hover:scale-[102%] flex flex-col items-center justify-center rounded-[45px] shadow-black shadow-md min-h-[20rem] max-h-[20rem] p-5 relative">
